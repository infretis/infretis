...
Check that you indeed are in the chair conformation with the given indices by using the `check-indices.py` script. Run `python check-indices.py -h` for usage information. You should obtain $\theta \approx =0$. 
