...
Check that you indeed are in the chair conformation with the given indices by using the `check-indices.py` script. Run `python check-indices.py -h` for usage information. You should obtain a  $\theta$ value of around 0 to $10^{\circ}$. 
