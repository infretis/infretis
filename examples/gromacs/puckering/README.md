...
* **10:** Given that the final product state of your molecule is defined by $\theta=90^{\circ}$, are you optimistic that you observe a spontaneous transition using plain MD?
