...
## Questions
* **4:** We will perform the exercise from the directory "~/infretis/examples/gromacs/puckering/". Get an overview of the folder structure an all the files we will be using by running
```bash
