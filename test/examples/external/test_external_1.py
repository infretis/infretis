...
class test_infretisrun(unittest.TestCase):
    ...
    def test_infretisrun_1worker_wf(self):
        ...
        with tempfile.TemporaryDirectory(dir='./') as tempdir:
            ...
            # run standard simulation start command
            os.system("sed -i -e '15 s/20/5/' infretis.toml >> out.txt")
            os.system("infretisrun -i infretis.toml >| out.txt")
            ...
            os.system("sed -i -e '15 s/5/10/' restart.toml >> out.txt")
            ...
            os.system("sed -i -e '15 s/10/15/' restart.toml >> out.txt")
            ...
            os.system("sed -i -e '15 s/15/20/' restart.toml >> out.txt")
