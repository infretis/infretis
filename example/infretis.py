...
#     for traj in out['accepted_trajs']:
#         traj.number = output_traj[0]
#     
#     return out

# def run_md2(ens, input_traj, sim, cycle):
...
#     if len(ens) == 1:
#         print('bling')
#         sim.ensembles[ens[0]]['path_ensemble'].last_path = input_traj
#         start_cond = sim.ensembles[ens[0]]['path_ensemble'].start_condition
#         tis_settings = sim.settings['ensemble'][ens[0]]['tis']
#         accept, trial, status = shoot(sim.ensembles[ens[0]],
#                                       tis_settings,
#                                       start_cond)
#         if accept:
#             out_traj = trial
...
#         out['ensembles'] = list(ens)
#         out['accepted_trajs'] = [out_traj]
#         out['traj_vectors'] = [cv_vector]
#     else:
#         print('blang')
#         accept, trial, status = retis_swap_zero(sim.ensembles,
#                                                sim.settings,
#                                                cycle)
#         if accept:
#             out_traj = trial
